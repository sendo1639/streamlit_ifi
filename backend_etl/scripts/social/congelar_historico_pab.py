...
=============================================================================
Versão autocontida: como o etl_historico_pab_ae.py já foi reescrito para
ler do arquivo estático (não busca mais da web), este script carrega a
própria lógica de coleta original, em vez de importar de lá.

Como usar (rodar UMA VEZ, localmente):
    %run "CAMINHO\\congelar_historico_pab.py"
"""
...
CAMINHO_SAIDA = Path(BASE_DIR).parent / 'data' / 'historico_auxilio_brasil_congelado.csv'
...
if __name__ == "__main__":
    ...
    if df_final.empty:
        ...
        print("   Agora suba esse arquivo pro repositório (git add).")